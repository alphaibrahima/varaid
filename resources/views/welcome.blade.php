    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8 offset-md-2 text-center">
                ...
                <h1 class="display-4 text-dark mb-4" style="color: #2c3e50;">
                    Réservez votre agneau pour l'Aïd
                </h1>
                
                <p class="lead text-muted mb-5">
                    Simplifiez votre préparation de l'Aïd Al-Adha avec VarAïd. 
                    Réservez facilement votre agneau et gérez votre commande en quelques clics.
                </p>
